...
Python code for a project focusing on "Group Recommendation Systems (GRS)" based on personality of the users.
"A personality-aware group recommendation system based on pairwise preferences (Infromation Science 2022)"
